<template>
    ...
    <div class="container">
        ...
        <div v-if="products">
            ...
            <div class="container">
                <div class="row">
                    <div class="col d-flex flex-wrap justify-content-lg-start justify-content-sm-center">
                        <div class="card m-4" style="width: 16rem;" v-for="product in filteredProducts"
                            :key="product.prodID">
            ...
            <div v-if="filteredProducts.length === 0">
                <h2><span>No</span> Items Found</h2>
            </div>
        </div>
        <div v-else>
